var size = 0;
var placement = 'point';
function categories_Redcarreteras_5(feature, value, size, resolution, labelText,
...
case 'NULL':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(225,94,181,0.85)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 0.38}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
var style_Redcarreteras_5 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_Redcarreteras_5(feature, value, size, resolution, labelText,
